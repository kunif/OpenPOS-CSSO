...
namespace OpenPOS.CSSO
{
    ...
    [ComVisible(true)]
    [Guid("2E0A62EB-9703-4D1C-BA2B-046A8670A491")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("OPOS.HardTotals.OpenPOS.CSSO.CSHardTotalsSO.1")]
    public class CSHardTotalsSO : IOPOSHardTotalsSO, IDisposable
    {
        ...
        internal int _freeData;
        internal int _numberOfFiles;
        internal int _totalsSize;
        internal bool _transactionInProgress;

        internal bool _capErrorDetection;
        internal bool _capSingleFile;
        internal bool _capTransactions;
        ...
        public CSHardTotalsSO()
        {
            ...
            _capErrorDetection = false;
            _capSingleFile = false;
            _capTransactions = false;
        ...
        {
            if (registerType != typeof(CSHardTotalsSO))
            {
                return;
            }
        ...
        public int GetPropertyNumber(int PropIndex)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSTotalsInternals.PIDXTot_FreeData:
                    value = _freeData;
                    break;

                case (int)OPOSTotalsInternals.PIDXTot_NumberOfFiles:
                    value = _numberOfFiles;
                    break;

                case (int)OPOSTotalsInternals.PIDXTot_TotalsSize:
                    value = _totalsSize;
                    break;

                case (int)OPOSTotalsInternals.PIDXTot_TransactionInProgress:
                    value = Convert.ToInt32(_transactionInProgress);
                    break;

                case (int)OPOSTotalsInternals.PIDXTot_CapErrorDetection:
                    value = Convert.ToInt32(_capErrorDetection);
                    break;

                case (int)OPOSTotalsInternals.PIDXTot_CapSingleFile:
                    value = Convert.ToInt32(_capSingleFile);
                    break;

                case (int)OPOSTotalsInternals.PIDXTot_CapTransactions:
                    value = Convert.ToInt32(_capTransactions);
                    break;
            }
        ...
        public int ClaimFile(int HTotalsFile, int Timeout)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int Create(string FileName, out int pHTotalsFile, int Size, bool ErrorDetection)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            pHTotalsFile = 0;
        ...
        public int Find(string FileName, out int pHTotalsFile, out int pSize)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            pHTotalsFile = 0;
        ...
        public int FindByIndex(int Index, out string pFileName)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
        ...
        public int Read(int HTotalsFile, out string pData, int Offset, int Count)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            pData = string.Empty;
        ...
        public int RecalculateValidationData(int HTotalsFile)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int ReleaseFile(int HTotalsFile)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int Rename(int HTotalsFile, string FileName)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int SetAll(int HTotalsFile, int Value)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int ValidateData(int HTotalsFile)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int Write(int HTotalsFile, string Data, int Offset, int Count)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
