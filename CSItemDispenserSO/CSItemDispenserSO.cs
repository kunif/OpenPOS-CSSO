...
namespace OpenPOS.CSSO
{
    ...
    [ComVisible(true)]
    [Guid("2E49A2D7-4542-461D-8013-F93C29119A7B")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("OPOS.ItemDispenser.OpenPOS.CSSO.CSItemDispenserSO.1")]
    public class CSItemDispenserSO : IOPOSItemDispenserSO, IDisposable
    {
        ...
        internal int _dispenserStatus;
        internal int _maxSlots;

        internal bool _capEmptySensor;
        internal bool _capIndividualSlotStatus;
        ...
        public CSItemDispenserSO()
        {
            ...
            _capIndividualSlotStatus = false;
            _capJamSensor = false;
        ...
        {
            if (registerType != typeof(CSItemDispenserSO))
            {
                return;
            }
        ...
        public int GetPropertyNumber(int PropIndex)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSItemDispenserInternals.PIDXItem_DispenserStatus:
                    value = _dispenserStatus;
                    break;

                case (int)OPOSItemDispenserInternals.PIDXItem_MaxSlots:
                    value = _maxSlots;
                    break;

                case (int)OPOSItemDispenserInternals.PIDXItem_CapEmptySensor:
                    value = Convert.ToInt32(_capEmptySensor);
                    break;

                case (int)OPOSItemDispenserInternals.PIDXItem_CapIndividualSlotStatus:
                    value = Convert.ToInt32(_capIndividualSlotStatus);
                    break;

                case (int)OPOSItemDispenserInternals.PIDXItem_CapJamSensor:
                    value = Convert.ToInt32(_capJamSensor);
                    break;

                case (int)OPOSItemDispenserInternals.PIDXItem_CapNearEmptySensor:
        ...
        public int AdjustItemCount(int ItemCount, int SlotNumber)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int DispenseItem(ref int pNumItem, int SlotNumber)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int ReadItemCount(ref int pItemCount, int SlotNumber)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
