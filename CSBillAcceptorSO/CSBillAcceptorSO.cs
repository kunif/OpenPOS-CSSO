...
namespace OpenPOS.CSSO
{
    ...
    [ComVisible(true)]
    [Guid("D6860699-1376-4E7A-838F-F0F53791EFBD")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("OPOS.BillAcceptor.OpenPOS.CSSO.CSBillAcceptorSO.1")]
    public class CSBillAcceptorSO : IOPOSBillAcceptorSO, IDisposable
    {
        ...
        public CSBillAcceptorSO()
        {
            ...
            _depositAmount = 0;
            _depositStatus = (int)OPOSBillAcceptorConstants.BACC_STATUS_DEPOSIT_END;
            _fullStatus = (int)OPOSBillAcceptorConstants.BACC_STATUS_OK;
        ...
        {
            if (registerType != typeof(CSBillAcceptorSO)) return;
        ...
        {
            if (registerType != typeof(CSBillAcceptorSO))
            {
                return;
            }
        }
        ...
        public int GetPropertyNumber(int PropIndex)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSBillAcceptorInternals.PIDXBacc_DepositAmount:
                    value = _depositAmount;
                    break;

                case (int)OPOSBillAcceptorInternals.PIDXBacc_DepositStatus:
                    value = _depositStatus;
                    break;

                case (int)OPOSBillAcceptorInternals.PIDXBacc_FullStatus:
                    value = _fullStatus;
                    break;

                case (int)OPOSBillAcceptorInternals.PIDXBacc_RealTimeDataEnabled:
                    value = Convert.ToInt32(_realTimeDataEnabled);
                    break;

                case (int)OPOSBillAcceptorInternals.PIDXBacc_CapDiscrepancy:
                    value = Convert.ToInt32(_capDiscrepancy);
                    break;

                case (int)OPOSBillAcceptorInternals.PIDXBacc_CapFullSensor:
                    value = Convert.ToInt32(_capFullSensor);
                    break;

                case (int)OPOSBillAcceptorInternals.PIDXBacc_CapJamSensor:
                    value = Convert.ToInt32(_capJamSensor);
                    break;

                case (int)OPOSBillAcceptorInternals.PIDXBacc_CapNearFullSensor:
                    value = Convert.ToInt32(_capNearFullSensor);
                    break;

                case (int)OPOSBillAcceptorInternals.PIDXBacc_CapPauseDeposit:
                    value = Convert.ToInt32(_capPauseDeposit);
                    break;

                case (int)OPOSBillAcceptorInternals.PIDXBacc_CapRealTimeData:
        ...
        public string GetPropertyString(int PropIndex)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSBillAcceptorInternals.PIDXBacc_CurrencyCode:
                    value = String.Copy(_currencyCode);
                    break;

                case (int)OPOSBillAcceptorInternals.PIDXBacc_DepositCashList:
                    value = String.Copy(_depositCashList);
                    break;

                case (int)OPOSBillAcceptorInternals.PIDXBacc_DepositCodeList:
                    value = String.Copy(_depositCodeList);
                    break;

                case (int)OPOSBillAcceptorInternals.PIDXBacc_DepositCounts:
                    value = String.Copy(_depositCounts);
                    break;
            }
