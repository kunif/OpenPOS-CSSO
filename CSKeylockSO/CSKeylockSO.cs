...
namespace OpenPOS.CSSO
{
    ...
    [ComVisible(true)]
    [Guid("E5BC80E1-3851-4D2F-B8AA-59175084D8B7")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("OPOS.Keylock.OpenPOS.CSSO.CSKeylockSO.1")]
    public class CSKeylockSO : IOPOSKeylockSO, IDisposable
    {
        ...
        internal int _KeyPosition;
        internal int _PositionCount;

        internal int _CapKeylockType;

        internal byte[] _ElectronicKeyValue;
        ...
        public CSKeylockSO()
        {
            ...
            _ElectronicKeyValue = new byte[0];
        ...
        {
            if (registerType != typeof(CSKeylockSO))
            {
                return;
            }
        ...
        public int GetPropertyNumber(int PropIndex)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSKeylockInternals.PIDXLock_KeyPosition:
                    value = _KeyPosition;
                    break;

                case (int)OPOSKeylockInternals.PIDXLock_PositionCount:
                    value = _PositionCount;
                    break;

                case (int)OPOSKeylockInternals.PIDXLock_CapKeylockType:
                    value = _CapKeylockType;
                    break;
            }
        ...
        public string GetPropertyString(int PropIndex)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSKeylockInternals.PIDXLock_ElectronicKeyValue:
                    value = SOCommon.ToStringFromByteArray(_ElectronicKeyValue, _binaryConversion);
                    break;
            }
        ...
        public int WaitForKeylockChange(int KeyPosition, int Timeout)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
