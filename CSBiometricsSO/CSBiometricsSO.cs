...
namespace OpenPOS.CSSO
{
    ...
    [ComVisible(true)]
    [Guid("D64633FE-B1BA-4B0F-9399-EB35D413B295")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("OPOS.Biometrics.OpenPOS.CSSO.CSBiometricsSO.1")]
    public class CSBiometricsSO : IOPOSBiometricsSO, IDisposable
    {
        ...
        internal int _algorithm;
        internal bool _realTimeDataEnabled;
        internal int _sensorBPP;
        internal int _sensorColor;
        internal int _sensorHeight;
        internal int _sensorOrientation;
        internal int _sensorType;
        internal int _sensorWidth;

        internal bool _capPrematchData;
        internal bool _capRawSensorData;
        internal bool _capRealTimeData;
        internal int _capSensorColor;
        internal int _capSensorOrientation;
        internal int _capSensorType;
        internal bool _capTemplateAdaptation;

        internal string _algorithmList;
        internal byte[] _bir;
        internal byte[] _rawSensorData;
        ...
        public CSBiometricsSO()
        {
            ...
            _capPrematchData = false;
            _capRawSensorData = false;
            _capRealTimeData = false;
            _capSensorColor = 0;
            _capSensorOrientation = 0;
            _capSensorType = 0;
            _capTemplateAdaptation = false;

            _algorithmList = string.Empty;
            _bir = new byte[0];
            _rawSensorData = new byte[0];
        ...
        {
            if (registerType != typeof(CSBiometricsSO))
            {
                return;
            }
        ...
        public int GetPropertyNumber(int PropIndex)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSBiometricsInternals.PIDXBio_Algorithm:
                    value = _algorithm;
                    break;

                case (int)OPOSBiometricsInternals.PIDXBio_RealTimeDataEnabled:
                    value = Convert.ToInt32(_realTimeDataEnabled);
                    break;

                case (int)OPOSBiometricsInternals.PIDXBio_SensorBPP:
                    value = _sensorBPP;
                    break;

                case (int)OPOSBiometricsInternals.PIDXBio_SensorColor:
                    value = _sensorColor;
                    break;

                case (int)OPOSBiometricsInternals.PIDXBio_SensorHeight:
                    value = _sensorHeight;
                    break;

                case (int)OPOSBiometricsInternals.PIDXBio_SensorOrientation:
                    value = _sensorOrientation;
                    break;

                case (int)OPOSBiometricsInternals.PIDXBio_SensorType:
                    value = _sensorType;
                    break;

                case (int)OPOSBiometricsInternals.PIDXBio_SensorWidth:
                    value = _sensorWidth;
                    break;

                case (int)OPOSBiometricsInternals.PIDXBio_CapPrematchData:
                    value = Convert.ToInt32(_capPrematchData);
                    break;

                case (int)OPOSBiometricsInternals.PIDXBio_CapRawSensorData:
                    value = Convert.ToInt32(_capRawSensorData);
                    break;

                case (int)OPOSBiometricsInternals.PIDXBio_CapRealTimeData:
                    value = Convert.ToInt32(_capRealTimeData);
                    break;

                case (int)OPOSBiometricsInternals.PIDXBio_CapSensorColor:
                    value = _capSensorColor;
                    break;

                case (int)OPOSBiometricsInternals.PIDXBio_CapSensorOrientation:
                    value = _capSensorOrientation;
                    break;

                case (int)OPOSBiometricsInternals.PIDXBio_CapSensorType:
                    value = _capSensorType;
                    break;

                case (int)OPOSBiometricsInternals.PIDXBio_CapTemplateAdaptation:
                    value = Convert.ToInt32(_capTemplateAdaptation);
                    break;
            }
        ...
        public string GetPropertyString(int PropIndex)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSBiometricsInternals.PIDXBio_AlgorithmList:
                    value = string.Copy(_algorithmList);
                    break;

                case (int)OPOSBiometricsInternals.PIDXBio_BIR:
                    value = SOCommon.ToStringFromByteArray(_bir, _binaryConversion);
                    break;

                case (int)OPOSBiometricsInternals.PIDXBio_RawSensorData:
                    value = SOCommon.ToStringFromByteArray(_rawSensorData, _binaryConversion);
                    break;
            }
        ...
        public int BeginEnrollCapture(string ReferenceBIR, string Payload)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int Identify(int MaxFARRequested, int MaxFRRRequested, bool FARPrecedence, object ReferenceBIRPopulation, ref object pCandidateRanking, int Timeout)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int IdentifyMatch(int MaxFARRequested, int MaxFRRRequested, bool FARPrecedence, string SampleBIR, object ReferenceBIRPopulation, ref object pCandidateRanking)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int ProcessPrematchData(string CapturedBIR, string PrematchDataBIR, ref string pProcessedBIR)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int Verify(int MaxFARRequested, int MaxFRRRequested, bool FARPrecedence, string ReferenceBIR, ref string pAdaptedBIR, ref bool pResult, ref int pFARAchieved, ref int pFRRAchieved, ref string pPayload, int Timeout)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int VerifyMatch(int MaxFARRequested, int MaxFRRRequested, bool FARPrecedence, string SampleBIR, string ReferenceBIR, ref string pAdaptedBIR, ref bool pResult, ref int pFARAchieved, ref int pFRRAchieved, ref string pPayload)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
