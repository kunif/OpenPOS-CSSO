...
namespace OpenPOS.CSSO
{
    ...
    [ComVisible(true)]
    [Guid("C2114A42-73AB-4B13-B940-63F06259E927")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("OPOS.RFIDScanner.OpenPOS.CSSO.CSRFIDScannerSO.1")]
    public class CSRFIDScannerSO : IOPOSRFIDScannerSO, IDisposable
    {
        ...
        internal bool _continuousReadMode;
        internal int _currentTagProtocol;
        internal int _protocolMask;
        internal int _readTimerInterval;
        internal int _tagCount;

        internal bool _capContinuousRead;
        internal bool _capDisableTag;
        internal bool _capLockTag;
        internal int _capMultipleProtocols;
        internal bool _capReadTimer;
        internal int _capWriteTag;

        internal byte[] _currentTagID;
        internal byte[] _currentTagUserData;
        ...
        public CSRFIDScannerSO()
        {
            ...
            _continuousReadMode = false;
            _currentTagProtocol = 0;
            _protocolMask = 0;
            _readTimerInterval = 0;
            _tagCount = 0;

            _capContinuousRead = false;
            _capDisableTag = false;
            _capLockTag = false;
            _capMultipleProtocols = 0;
            _capReadTimer = false;
            _capWriteTag = 0;

            _currentTagID = new byte[0];
            _currentTagUserData = new byte[0];
        ...
        {
            if (registerType != typeof(CSRFIDScannerSO))
            {
                return;
            }
        ...
        public int GetPropertyNumber(int PropIndex)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSRFIDScannerInternals.PIDXRfid_ContinuousReadMode:
                    value = Convert.ToInt32(_continuousReadMode);
                    break;

                case (int)OPOSRFIDScannerInternals.PIDXRfid_CurrentTagProtocol:
                    value = _currentTagProtocol;
                    break;

                case (int)OPOSRFIDScannerInternals.PIDXRfid_ProtocolMask:
                    value = _protocolMask;
                    break;

                case (int)OPOSRFIDScannerInternals.PIDXRfid_ReadTimerInterval:
                    value = _readTimerInterval;
                    break;

                case (int)OPOSRFIDScannerInternals.PIDXRfid_TagCount:
                    value = _tagCount;
                    break;

                case (int)OPOSRFIDScannerInternals.PIDXRfid_CapContinuousRead:
                    value = Convert.ToInt32(_capContinuousRead);
                    break;

                case (int)OPOSRFIDScannerInternals.PIDXRfid_CapDisableTag:
                    value = Convert.ToInt32(_capDisableTag);
                    break;

                case (int)OPOSRFIDScannerInternals.PIDXRfid_CapLockTag:
                    value = Convert.ToInt32(_capLockTag);
                    break;

                case (int)OPOSRFIDScannerInternals.PIDXRfid_CapMultipleProtocols:
                    value = _capMultipleProtocols;
                    break;

                case (int)OPOSRFIDScannerInternals.PIDXRfid_CapReadTimer:
                    value = Convert.ToInt32(_capReadTimer);
                    break;

                case (int)OPOSRFIDScannerInternals.PIDXRfid_CapWriteTag:
                    value = _capWriteTag;
                    break;
            }
        ...
        public string GetPropertyString(int PropIndex)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSRFIDScannerInternals.PIDXRfid_CurrentTagID:
                    value = SOCommon.ToStringFromByteArray(_currentTagID, _binaryConversion);
                    break;

                case (int)OPOSRFIDScannerInternals.PIDXRfid_CurrentTagUserData:
                    value = SOCommon.ToStringFromByteArray(_currentTagUserData, _binaryConversion);
                    break;
            }
        ...
        public int DisableTag(string TagID, int Timeout, string Password)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int LockTag(string TagID, int Timeout, string Password)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int ReadTags(int Cmd, string FilterID, string Filtermask, int Start, int Length, int Timeout, string Password)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int StartReadTags(int Cmd, string FilterID, string Filtermask, int Start, int Length, string Password)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int StopReadTags(string Password)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int WriteTagData(string TagID, string Userdata, int Start, int Timeout, string Password)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int WriteTagID(string SourceID, string DestID, int Timeout, string Password)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
