...
namespace OpenPOS.CSSO
{
    ...
    [ComVisible(true)]
    [Guid("6B954BD5-2931-4BE2-9920-FE51FE18CB65")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("OPOS.SmartCardRW.OpenPOS.CSSO.CSSmartCardRWSO.1")]
    public class CSSmartCardRWSO : IOPOSSmartCardRWSO, IDisposable
    {
        ...
        internal int _interfaceMode;
        internal int _isoEmvMode;
        internal int _scPresentSensor;
        internal int _scSlot;
        internal bool _transactionInProgress;
        internal int _transmissionProtocol;

        internal bool _capCardErrorDetection;
        internal int _capInterfaceMode;
        internal int _capIsoEmvMode;
        internal int _capSCPresentSensor;
        internal int _capSCSlots;
        internal int _capTransmissionProtocol;
        ...
        public CSSmartCardRWSO()
        {
            ...
            _transmissionProtocol = 0;

            _capCardErrorDetection = false;
            _capInterfaceMode = 0;
            _capIsoEmvMode = 0;
            _capSCPresentSensor = 0;
            _capSCSlots = 0;
            _capTransmissionProtocol = 0;
        ...
        {
            if (registerType != typeof(CSSmartCardRWSO))
            {
                return;
            }
        ...
        public int GetPropertyNumber(int PropIndex)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSSmartCardRWInternals.PIDXScrw_InterfaceMode:
                    value = _interfaceMode;
                    break;

                case (int)OPOSSmartCardRWInternals.PIDXScrw_IsoEmvMode:
                    value = _isoEmvMode;
                    break;

                case (int)OPOSSmartCardRWInternals.PIDXScrw_SCPresentSensor:
                    value = _scPresentSensor;
                    break;

                case (int)OPOSSmartCardRWInternals.PIDXScrw_SCSlot:
                    value = _scSlot;
                    break;

                case (int)OPOSSmartCardRWInternals.PIDXScrw_TransactionInProgress:
                    value = Convert.ToInt32(_transactionInProgress);
                    break;

                case (int)OPOSSmartCardRWInternals.PIDXScrw_TransmissionProtocol:
                    value = _transmissionProtocol;
                    break;

                case (int)OPOSSmartCardRWInternals.PIDXScrw_CapCardErrorDetection:
                    value = Convert.ToInt32(_capCardErrorDetection);
                    break;

                case (int)OPOSSmartCardRWInternals.PIDXScrw_CapInterfaceMode:
                    value = _capInterfaceMode;
                    break;

                case (int)OPOSSmartCardRWInternals.PIDXScrw_CapIsoEmvMode:
                    value = _capIsoEmvMode;
                    break;

                case (int)OPOSSmartCardRWInternals.PIDXScrw_CapSCPresentSensor:
                    value = _capSCPresentSensor;
                    break;

                case (int)OPOSSmartCardRWInternals.PIDXScrw_CapSCSlots:
                    value = _capSCSlots;
                    break;

                case (int)OPOSSmartCardRWInternals.PIDXScrw_CapTransmissionProtocol:
                    value = _capTransmissionProtocol;
                    break;
            }
        ...
        public int ReadData(int Action, ref int pCount, ref string pData)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int WriteData(int Action, int Count, string Data)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
