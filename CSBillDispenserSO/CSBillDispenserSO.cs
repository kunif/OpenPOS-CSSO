...
namespace OpenPOS.CSSO
{
    ...
    [ComVisible(true)]
    [Guid("86DCEEA9-7D9C-4388-8EBB-B8D2456882B0")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("OPOS.BillDispenser.OpenPOS.CSSO.CSBillDispenserSO.1")]
    public class CSBillDispenserSO : IOPOSBillDispenserSO, IDisposable
    {
        ...
        public CSBillDispenserSO()
        {
            ...
            _currentExit = 1;
            _deviceExits = 1;
            _deviceStatus = (int)OPOSBillDispenserConstants.BDSP_STATUS_OK;
        ...
        {
            if (registerType != typeof(CSBillDispenserSO))
            {
                return;
            }
        ...
        public int GetPropertyNumber(int PropIndex)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSBillDispenserInternals.PIDXBdsp_AsyncMode:
                    value = Convert.ToInt32(_asyncMode);
                    break;

                case (int)OPOSBillDispenserInternals.PIDXBdsp_AsyncResultCode:
                    value = _asyncResultCode;
                    break;

                case (int)OPOSBillDispenserInternals.PIDXBdsp_AsyncResultCodeExtended:
                    value = _asyncResultCodeExtended;
                    break;

                case (int)OPOSBillDispenserInternals.PIDXBdsp_CurrentExit:
                    value = _currentExit;
                    break;

                case (int)OPOSBillDispenserInternals.PIDXBdsp_DeviceExits:
                    value = _deviceExits;
                    break;

                case (int)OPOSBillDispenserInternals.PIDXBdsp_DeviceStatus:
                    value = _deviceStatus;
                    break;

                case (int)OPOSBillDispenserInternals.PIDXBdsp_CapDiscrepancy:
                    value = Convert.ToInt32(_capDiscrepancy);
                    break;

                case (int)OPOSBillDispenserInternals.PIDXBdsp_CapFullSensor:
                    value = Convert.ToInt32(_capFullSensor);
                    break;

                case (int)OPOSBillDispenserInternals.PIDXBdsp_CapJamSensor:
                    value = Convert.ToInt32(_capJamSensor);
                    break;

                case (int)OPOSBillDispenserInternals.PIDXBdsp_CapNearFullSensor:
        ...
        public string GetPropertyString(int PropIndex)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSBillDispenserInternals.PIDXBdsp_CurrencyCashList:
                    value = string.Copy(_currencyCashList);
                    break;

                case (int)OPOSBillDispenserInternals.PIDXBdsp_CurrencyCode:
                    value = string.Copy(_currencyCode);
                    break;

                case (int)OPOSBillDispenserInternals.PIDXBdsp_CurrencyCodeList:
                    value = string.Copy(_currencyCodeList);
                    break;

                case (int)OPOSBillDispenserInternals.PIDXBdsp_ExitCashList:
                    value = string.Copy(_exitCashList);
                    break;
            }
