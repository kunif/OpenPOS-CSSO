...
namespace OpenPOS.CSSO
{
    ...
    [ComVisible(true)]
    [Guid("DEF61720-4DF7-464A-BFF9-5959148FCF42")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("OPOS.SoundPlayer.OpenPOS.CSSO.CSSoundPlayerSO.1")]
    public class CSSoundPlayerSO : IOPOSSoundPlayerSO, IDisposable
    {
        ...
        {
            if (registerType != typeof(CSSoundPlayerSO))
            {
                return;
            }
        ...
        public int GetPropertyNumber(int PropIndex)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSSoundPlayerInternals.PIDXSply_Storage:
                    value = _storage;
                    break;

                case (int)OPOSSoundPlayerInternals.PIDXSply_Volume:
                    value = Convert.ToInt32(_volume);
                    break;

                case (int)OPOSSoundPlayerInternals.PIDXSply_CapMultiPlay:
                    value = Convert.ToInt32(_capMultiPlay);
                    break;

                case (int)OPOSSoundPlayerInternals.PIDXSply_CapStorage:
                    value = _capStorage;
                    break;

                case (int)OPOSSoundPlayerInternals.PIDXSply_CapVolume:
        ...
        public string GetPropertyString(int PropIndex)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSSoundPlayerInternals.PIDXSply_DeviceSoundList:
                    value = string.Copy(_deviceSoundList);
                    break;

                case (int)OPOSSoundPlayerInternals.PIDXSply_OutputIDList:
                    value = string.Copy(_outputIDList);
                    break;

                case (int)OPOSSoundPlayerInternals.PIDXSply_CapAssociatedHardTotalsDevice:
                    value = string.Copy(_capAssociatedHardTotalsDevice);
                    break;

                case (int)OPOSSoundPlayerInternals.PIDXSply_CapSoundTypeList:
                    value = string.Copy(_capSoundTypeList);
                    break;
            }
        ...
        public int PlaySound(string FileName, bool Loop)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int StopSound(int OutputID)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
