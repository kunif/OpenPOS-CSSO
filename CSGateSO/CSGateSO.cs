...
namespace OpenPOS.CSSO
{
    ...
    [ComVisible(true)]
    [Guid("41962C16-0751-48B1-9E92-BD1584147A67")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("OPOS.Gate.OpenPOS.CSSO.CSGateSO.1")]
    public class CSGateSO : IOPOSGateSO, IDisposable
    {
        ...
        internal int _gateStatus;

        internal bool _capGateStatus;
        ...
        public CSGateSO()
        {
            ...
            _gateStatus = (int)OPOSGateConstants.GATE_GS_CLOSED;

            _capGateStatus = false;
        ...
        {
            if (registerType != typeof(CSGateSO))
            {
                return;
            }
        ...
        public int GetPropertyNumber(int PropIndex)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSGateInternals.PIDXGate_GateStatus:
                    value = _gateStatus;
                    break;

                case (int)OPOSGateInternals.PIDXGate_CapGateStatus:
                    value = Convert.ToInt32(_capGateStatus);
                    break;
            }
        ...
        public int WaitForGateClose(int Timeout)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
