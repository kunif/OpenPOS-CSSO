...
namespace OpenPOS.CSSO
{
    ...
    [ComVisible(true)]
    [Guid("DDDCD3FC-4DF4-4351-B550-170F277E325C")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("OPOS.CoinDispenser.OpenPOS.CSSO.CSCoinDispenserSO.1")]
    public class CSCoinDispenserSO : IOPOSCoinDispenserSO, IDisposable
    {
        ...
        public CSCoinDispenserSO()
        {
            ...
            _dispenserStatus = (int)OPOSCoinDispenserConstants.COIN_STATUS_OK;
        ...
        {
            if (registerType != typeof(CSCoinDispenserSO))
            {
                return;
            }
        ...
        public int GetPropertyNumber(int PropIndex)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSCoinDispenserInternals.PIDXCoin_DispenserStatus:
                    value = _dispenserStatus;
                    break;

                case (int)OPOSCoinDispenserInternals.PIDXCoin_CapEmptySensor:
                    value = Convert.ToInt32(_capEmptySensor);
                    break;

                case (int)OPOSCoinDispenserInternals.PIDXCoin_CapJamSensor:
                    value = Convert.ToInt32(_capJamSensor);
                    break;

                case (int)OPOSCoinDispenserInternals.PIDXCoin_CapNearEmptySensor:
