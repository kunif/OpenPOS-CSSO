...
namespace OpenPOS.CSSO
{
    ...
    [ComVisible(true)]
    [Guid("72105650-AB65-45C6-95AC-CF32D888B855")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("OPOS.ToneIndicator.OpenPOS.CSSO.CSToneIndicatorSO.1")]
    public class CSToneIndicatorSO : IOPOSToneIndicatorSO, IDisposable
    {
        ...
        internal int _tone1Pitch;
        internal int _tone1Volume;
        internal int _tone1Duration;
        internal int _tone2Pitch;
        internal int _tone2Volume;
        internal int _tone2Duration;
        internal int _interToneWait;
        internal int _melodyType;
        internal int _melodyVolume;

        internal bool _capPitch;
        internal bool _capVolume;
        internal bool _capMelody;
        ...
        {
            if (registerType != typeof(CSToneIndicatorSO))
            {
                return;
            }
        ...
        public int GetPropertyNumber(int PropIndex)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSToneIndicatorInternals.PIDXTone_AsyncMode:
                    value = Convert.ToInt32(_asyncMode);
                    break;

                case (int)OPOSToneIndicatorInternals.PIDXTone_Tone1Pitch:
                    value = _tone1Pitch;
                    break;

                case (int)OPOSToneIndicatorInternals.PIDXTone_Tone1Volume:
                    value = _tone1Volume;
                    break;

                case (int)OPOSToneIndicatorInternals.PIDXTone_Tone1Duration:
                    value = _tone1Duration;
                    break;

                case (int)OPOSToneIndicatorInternals.PIDXTone_Tone2Pitch:
                    value = _tone2Pitch;
                    break;

                case (int)OPOSToneIndicatorInternals.PIDXTone_Tone2Volume:
                    value = _tone2Volume;
                    break;

                case (int)OPOSToneIndicatorInternals.PIDXTone_Tone2Duration:
                    value = _tone2Duration;
                    break;

                case (int)OPOSToneIndicatorInternals.PIDXTone_InterToneWait:
                    value = _interToneWait;
                    break;

                case (int)OPOSToneIndicatorInternals.PIDXTone_MelodyType:
                    value = _melodyType;
                    break;

                case (int)OPOSToneIndicatorInternals.PIDXTone_MelodyVolume:
                    value = _melodyVolume;
                    break;

                case (int)OPOSToneIndicatorInternals.PIDXTone_CapPitch:
                    value = Convert.ToInt32(_capPitch);
                    break;

                case (int)OPOSToneIndicatorInternals.PIDXTone_CapVolume:
                    value = Convert.ToInt32(_capVolume);
                    break;

                case (int)OPOSToneIndicatorInternals.PIDXTone_CapMelody:
                    value = Convert.ToInt32(_capMelody);
                    break;
            }
        ...
        public void SetPropertyNumber(int PropIndex, int Number)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSToneIndicatorInternals.PIDXTone_Tone2Duration:
                    _tone2Duration = Number;
                    break;

                case (int)OPOSToneIndicatorInternals.PIDXTone_InterToneWait:
                    _interToneWait = Number;
                    break;
        ...
        public int Sound(int NumberOfCycles, int InterSoundWait)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
