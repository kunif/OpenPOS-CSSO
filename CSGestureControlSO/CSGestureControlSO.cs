...
namespace OpenPOS.CSSO
{
    ...
    [ComVisible(true)]
    [Guid("217A49EA-9AE6-4437-A158-66A8B3239B9C")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("OPOS.GestureControl.OpenPOS.CSSO.CSGestureControlSO.1")]
    public class CSGestureControlSO : IOPOSGestureControlSO, IDisposable
    {
        ...
        internal int _poseCreationMode;
        internal int _storage;

        internal bool _capMotion;
        internal bool _capMotionCreation;
        internal bool _capPose;
        internal bool _capPoseCreation;
        internal int _capStorage;

        internal string _autoMode;
        internal string _autoModeList;
        internal string _jointList;
        internal string _motionList;
        internal string _poseList;
        ...
        public CSGestureControlSO()
        {
            ...
            _capMotion = false;
            _capMotionCreation = false;
            _capPose = false;
            _capPoseCreation = false;
            _capStorage = 0;

            _autoMode = string.Empty;
            _autoModeList = string.Empty;
            _jointList = string.Empty;
            _motionList = string.Empty;
            _poseList = string.Empty;
        ...
        {
            if (registerType != typeof(CSGestureControlSO))
            {
                return;
            }
        ...
        public int GetPropertyNumber(int PropIndex)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSGestureControlInternals.PIDXGctl_PoseCreationMode:
                    value = _poseCreationMode;
                    break;

                case (int)OPOSGestureControlInternals.PIDXGctl_Storage:
                    value = _storage;
                    break;

                case (int)OPOSGestureControlInternals.PIDXGctl_CapMotion:
                    value = Convert.ToInt32(_capMotion);
                    break;

                case (int)OPOSGestureControlInternals.PIDXGctl_CapMotionCreation:
                    value = Convert.ToInt32(_capMotionCreation);
                    break;

                case (int)OPOSGestureControlInternals.PIDXGctl_CapPose:
                    value = Convert.ToInt32(_capPose);
                    break;

                case (int)OPOSGestureControlInternals.PIDXGctl_CapPoseCreation:
                    value = Convert.ToInt32(_capPoseCreation);
                    break;

                case (int)OPOSGestureControlInternals.PIDXGctl_CapStorage:
                    value = _capStorage;
                    break;
            }
        ...
        public string GetPropertyString(int PropIndex)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSGestureControlInternals.PIDXGctl_AutoMode:
                    value = string.Copy(_autoMode);
                    break;

                case (int)OPOSGestureControlInternals.PIDXGctl_AutoModeList:
                    value = string.Copy(_autoModeList);
                    break;

                case (int)OPOSGestureControlInternals.PIDXGctl_JointList:
                    value = string.Copy(_jointList);
                    break;

                case (int)OPOSGestureControlInternals.PIDXGctl_MotionList:
                    value = string.Copy(_motionList);
                    break;

                case (int)OPOSGestureControlInternals.PIDXGctl_PoseList:
                    value = string.Copy(_poseList);
                    break;

                case (int)OPOSGestureControlInternals.PIDXGctl_CapAssociatedHardTotalsDevice:
        ...
        public int CreateMotion(string FileName, string PoseList)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int CreatePose(string FileName, int Time)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int GetPosition(string JointID, out int pPosition)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            pPosition = 0;
        ...
        public int SetPosition(string PositionList, int Time, bool Absolute)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int SetSpeed(string SpeedList, int Time)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int StartMotion(string FileName)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int StartPose(string FileName)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int StopControl(int OutputID)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
