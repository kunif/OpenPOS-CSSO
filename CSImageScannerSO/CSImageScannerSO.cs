...
namespace OpenPOS.CSSO
{
    ...
    [ComVisible(true)]
    [Guid("25C47193-CF26-4395-9689-445ABDD517C7")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("OPOS.ImageScanner.OpenPOS.CSSO.CSImageScannerSO.1")]
    public class CSImageScannerSO : IOPOSImageScannerSO, IDisposable
    {
        ...
        internal int _frameType;
        internal bool _illuminateMode;
        internal int _imageHeight;
        internal int _imageLength;
        internal int _imageMode;
        internal int _imageQuality;
        internal int _imageType;
        internal int _imageWidth;
        internal int _videoCount;
        internal int _videoRate;

        internal bool _capAim;
        internal bool _capDecodeData;
        internal bool _capHostTriggered;
        internal bool _capIlluminate;
        internal bool _capImageData;
        internal bool _capImageQuality;
        internal bool _capVideoData;
        ...
        public CSImageScannerSO()
        {
            ...
            _capAim = false;
            _capDecodeData = false;
            _capHostTriggered = false;
            _capIlluminate = false;
            _capImageData = false;
            _capImageQuality = false;
            _capVideoData = false;

            _frameData = new byte[0];
        ...
        {
            if (registerType != typeof(CSImageScannerSO))
            {
                return;
            }
        ...
        public int GetPropertyNumber(int PropIndex)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSImageScannerInternals.PIDXImg_AimMode:
                    value = Convert.ToInt32(_aimMode);
                    break;

                case (int)OPOSImageScannerInternals.PIDXImg_BitsPerPixel:
                    value = _bitsPerPixel;
                    break;

                case (int)OPOSImageScannerInternals.PIDXImg_FrameType:
                    value = _frameType;
                    break;

                case (int)OPOSImageScannerInternals.PIDXImg_IlluminateMode:
                    value = Convert.ToInt32(_illuminateMode);
                    break;

                case (int)OPOSImageScannerInternals.PIDXImg_ImageHeight:
                    value = _imageHeight;
                    break;

                case (int)OPOSImageScannerInternals.PIDXImg_ImageLength:
                    value = _imageLength;
                    break;

                case (int)OPOSImageScannerInternals.PIDXImg_ImageMode:
                    value = _imageMode;
                    break;

                case (int)OPOSImageScannerInternals.PIDXImg_ImageQuality:
                    value = _imageQuality;
                    break;

                case (int)OPOSImageScannerInternals.PIDXImg_ImageType:
                    value = _imageType;
                    break;

                case (int)OPOSImageScannerInternals.PIDXImg_ImageWidth:
                    value = _imageWidth;
                    break;

                case (int)OPOSImageScannerInternals.PIDXImg_VideoCount:
                    value = _videoCount;
                    break;

                case (int)OPOSImageScannerInternals.PIDXImg_VideoRate:
                    value = _videoRate;
                    break;

                case (int)OPOSImageScannerInternals.PIDXImg_CapAim:
                    value = Convert.ToInt32(_capAim);
                    break;

                case (int)OPOSImageScannerInternals.PIDXImg_CapDecodeData:
                    value = Convert.ToInt32(_capDecodeData);
                    break;

                case (int)OPOSImageScannerInternals.PIDXImg_CapHostTriggered:
                    value = Convert.ToInt32(_capHostTriggered);
                    break;

                case (int)OPOSImageScannerInternals.PIDXImg_CapIlluminate:
                    value = Convert.ToInt32(_capIlluminate);
                    break;

                case (int)OPOSImageScannerInternals.PIDXImg_CapImageData:
                    value = Convert.ToInt32(_capImageData);
                    break;

                case (int)OPOSImageScannerInternals.PIDXImg_CapImageQuality:
                    value = Convert.ToInt32(_capImageQuality);
                    break;

                case (int)OPOSImageScannerInternals.PIDXImg_CapVideoData:
                    value = Convert.ToInt32(_capVideoData);
                    break;
            }
        ...
        public void SetPropertyNumber(int PropIndex, int Number)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSImageScannerInternals.PIDXImg_AimMode:
                    _aimMode = Convert.ToBoolean(Number);
                    break;

                case (int)OPOSImageScannerInternals.PIDXImg_IlluminateMode:
                    _illuminateMode = Convert.ToBoolean(Number);
                    break;
        ...
        public string GetPropertyString(int PropIndex)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSImageScannerInternals.PIDXImg_FrameData:
                    value = SOCommon.ToStringFromByteArray(_frameData, _binaryConversion);
                    break;
            }
