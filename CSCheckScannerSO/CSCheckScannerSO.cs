...
namespace OpenPOS.CSSO
{
    ...
    [ComVisible(true)]
    [Guid("087B84C7-A53A-438B-927B-CDCAFB33B01A")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("OPOS.CheckScanner.OpenPOS.CSSO.CSCheckScannerSO.1")]
    public class CSCheckScannerSO : IOPOSCheckScannerSO, IDisposable
    {
        ...
        internal int _color;
        internal bool _concurrentMICR;
        internal int _cropAreaCount;
        internal int _documentHeight;
        internal int _documentWidth;
        internal int _fileIndex;
        internal int _imageFormat;
        internal int _imageMemoryStatus;
        internal int _mapMode;
        internal int _maxCropAreas;
        internal int _quality;
        internal int _remainingImagesEstimate;
        internal int _contrast;

        internal bool _capAutoGenerateFileID;
        internal bool _capAutoGenerateImageTagData;
        internal bool _capAutoSize;
        internal int _capColor;
        internal bool _capConcurrentMICR;
        internal bool _capDefineCropArea;
        internal int _capImageFormat;
        internal bool _capImageTagData;
        internal bool _capMICRDevice;
        internal bool _capStoreImageFiles;
        internal bool _capValidationDevice;
        internal bool _capAutoContrast;
        internal bool _capContrast;

        internal string _fileID;
        internal byte[] _imageData;
        internal string _imageTagData;
        internal string _qualityList;
        ...
        public CSCheckScannerSO()
        {
            ...
            _color = 0;
            _concurrentMICR = false;
            _cropAreaCount = 0;
            _documentHeight = 0;
            _documentWidth = 0;
            _fileIndex = 0;
            _imageFormat = 0;
            _imageMemoryStatus = 0;
            _mapMode = 0;
            _maxCropAreas = 0;
            _quality = 0;
            _remainingImagesEstimate = 0;
            _contrast = 0;

            _capAutoGenerateFileID = false;
            _capAutoGenerateImageTagData = false;
            _capAutoSize = false;
            _capColor = 0;
            _capConcurrentMICR = false;
            _capDefineCropArea = false;
            _capImageFormat = 0;
            _capImageTagData = false;
            _capMICRDevice = false;
            _capStoreImageFiles = false;
            _capValidationDevice = false;
            _capAutoContrast = false;
            _capContrast = false;

            _fileID = string.Empty;
            _imageData = new byte[0];
            _imageTagData = string.Empty;
            _qualityList = string.Empty;
        ...
        {
            if (registerType != typeof(CSCheckScannerSO))
            {
                return;
            }
        ...
        public int GetPropertyNumber(int PropIndex)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSCheckScannerInternals.PIDXChk_Color:
                    value = _color;
                    break;

                case (int)OPOSCheckScannerInternals.PIDXChk_ConcurrentMICR:
                    value = Convert.ToInt32(_concurrentMICR);
                    break;

                case (int)OPOSCheckScannerInternals.PIDXChk_CropAreaCount:
                    value = _cropAreaCount;
                    break;

                case (int)OPOSCheckScannerInternals.PIDXChk_DocumentHeight:
                    value = _documentHeight;
                    break;

                case (int)OPOSCheckScannerInternals.PIDXChk_DocumentWidth:
                    value = _documentWidth;
                    break;

                case (int)OPOSCheckScannerInternals.PIDXChk_FileIndex:
                    value = _fileIndex;
                    break;

                case (int)OPOSCheckScannerInternals.PIDXChk_ImageFormat:
                    value = _imageFormat;
                    break;

                case (int)OPOSCheckScannerInternals.PIDXChk_ImageMemoryStatus:
                    value = _imageMemoryStatus;
                    break;

                case (int)OPOSCheckScannerInternals.PIDXChk_MapMode:
                    value = _mapMode;
                    break;

                case (int)OPOSCheckScannerInternals.PIDXChk_MaxCropAreas:
                    value = _maxCropAreas;
                    break;

                case (int)OPOSCheckScannerInternals.PIDXChk_Quality:
                    value = _quality;
                    break;

                case (int)OPOSCheckScannerInternals.PIDXChk_RemainingImagesEstimate:
                    value = _remainingImagesEstimate;
                    break;

                case (int)OPOSCheckScannerInternals.PIDXChk_Contrast:
                    value = _contrast;
                    break;

                case (int)OPOSCheckScannerInternals.PIDXChk_CapAutoGenerateFileID:
                    value = Convert.ToInt32(_capAutoGenerateFileID);
                    break;

                case (int)OPOSCheckScannerInternals.PIDXChk_CapAutoGenerateImageTagData:
                    value = Convert.ToInt32(_capAutoGenerateImageTagData);
                    break;

                case (int)OPOSCheckScannerInternals.PIDXChk_CapAutoSize:
                    value = Convert.ToInt32(_capAutoSize);
                    break;

                case (int)OPOSCheckScannerInternals.PIDXChk_CapColor:
                    value = _capColor;
                    break;

                case (int)OPOSCheckScannerInternals.PIDXChk_CapConcurrentMICR:
                    value = Convert.ToInt32(_capConcurrentMICR);
                    break;

                case (int)OPOSCheckScannerInternals.PIDXChk_CapDefineCropArea:
                    value = Convert.ToInt32(_capDefineCropArea);
                    break;

                case (int)OPOSCheckScannerInternals.PIDXChk_CapImageFormat:
                    value = _capImageFormat;
                    break;

                case (int)OPOSCheckScannerInternals.PIDXChk_CapImageTagData:
                    value = Convert.ToInt32(_capImageTagData);
                    break;

                case (int)OPOSCheckScannerInternals.PIDXChk_CapMICRDevice:
                    value = Convert.ToInt32(_capMICRDevice);
                    break;

                case (int)OPOSCheckScannerInternals.PIDXChk_CapStoreImageFiles:
                    value = Convert.ToInt32(_capStoreImageFiles);
                    break;

                case (int)OPOSCheckScannerInternals.PIDXChk_CapValidationDevice:
                    value = Convert.ToInt32(_capValidationDevice);
                    break;

                case (int)OPOSCheckScannerInternals.PIDXChk_CapAutoContrast:
                    value = Convert.ToInt32(_capAutoContrast);
                    break;

                case (int)OPOSCheckScannerInternals.PIDXChk_CapContrast:
        ...
        public void SetPropertyNumber(int PropIndex, int Number)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSCheckScannerInternals.PIDXChk_ConcurrentMICR:
                    _concurrentMICR = Convert.ToBoolean(Number);
                    break;
        ...
        public string GetPropertyString(int PropIndex)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSCheckScannerInternals.PIDXChk_FileID:
                    value = _fileID;
                    break;

                case (int)OPOSCheckScannerInternals.PIDXChk_ImageData:
                    value = SOCommon.ToStringFromByteArray(_imageData, _binaryConversion);
                    break;

                case (int)OPOSCheckScannerInternals.PIDXChk_ImageTagData:
                    value = _imageTagData;
                    break;

                case (int)OPOSCheckScannerInternals.PIDXChk_QualityList:
                    value = _qualityList;
                    break;
            }
        ...
        public int DefineCropArea(int CropAreaID, int X, int Y, int CX, int CY)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int RetrieveImage(int CropAreaID)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int RetrieveMemory(int By)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int StoreImage(int CropAreaID)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
