...
namespace OpenPOS.CSSO
{
    ...
    [ComVisible(true)]
    [Guid("0ADFD046-8001-478D-AC72-16D4C81CB194")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("OPOS.GraphicDisplay.OpenPOS.CSSO.CSGraphicDisplaySO.1")]
    public class CSGraphicDisplaySO : IOPOSGraphicDisplaySO, IDisposable
    {
        ...
        internal int _displayMode;
        internal int _loadStatus;
        internal int _storage;
        internal int _volume;

        internal bool _capBrightness;
        internal bool _capImageType;
        internal int _capStorage;
        internal bool _capURLBack;
        internal bool _capURLForward;
        internal bool _capVideoType;
        internal bool _capVolume;

        internal string _imageType;
        internal string _imageTypeList;
        ...
        public CSGraphicDisplaySO()
        {
            ...
            _capStorage = 0;
            _capURLBack = false;
            _capURLForward = false;
            _capVideoType = false;
            _capVolume = false;

            _imageType = string.Empty;
            _imageTypeList = string.Empty;
            _url = string.Empty;
        ...
        {
            if (registerType != typeof(CSGraphicDisplaySO))
            {
                return;
            }
        ...
        public int GetPropertyNumber(int PropIndex)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSGraphicDisplayInternals.PIDXGdsp_Brightness:
                    value = _brightness;
                    break;

                case (int)OPOSGraphicDisplayInternals.PIDXGdsp_DisplayMode:
                    value = _displayMode;
                    break;

                case (int)OPOSGraphicDisplayInternals.PIDXGdsp_LoadStatus:
                    value = _loadStatus;
                    break;

                case (int)OPOSGraphicDisplayInternals.PIDXGdsp_Storage:
                    value = _storage;
                    break;

                case (int)OPOSGraphicDisplayInternals.PIDXGdsp_Volume:
                    value = _volume;
                    break;

                case (int)OPOSGraphicDisplayInternals.PIDXGdsp_CapBrightness:
                    value = Convert.ToInt32(_capBrightness);
                    break;

                case (int)OPOSGraphicDisplayInternals.PIDXGdsp_CapImageType:
                    value = Convert.ToInt32(_capImageType);
                    break;

                case (int)OPOSGraphicDisplayInternals.PIDXGdsp_CapStorage:
                    value = _capStorage;
                    break;

                case (int)OPOSGraphicDisplayInternals.PIDXGdsp_CapURLBack:
                    value = Convert.ToInt32(_capURLBack);
                    break;

                case (int)OPOSGraphicDisplayInternals.PIDXGdsp_CapURLForward:
                    value = Convert.ToInt32(_capURLForward);
                    break;

                case (int)OPOSGraphicDisplayInternals.PIDXGdsp_CapVideoType:
                    value = Convert.ToInt32(_capVideoType);
                    break;

                case (int)OPOSGraphicDisplayInternals.PIDXGdsp_CapVolume:
                    value = Convert.ToInt32(_capVolume);
                    break;
            }
        ...
        public string GetPropertyString(int PropIndex)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSGraphicDisplayInternals.PIDXGdsp_ImageType:
                    value = string.Copy(_imageType);
                    break;

                case (int)OPOSGraphicDisplayInternals.PIDXGdsp_ImageTypeList:
                    value = string.Copy(_imageTypeList);
                    break;

                case (int)OPOSGraphicDisplayInternals.PIDXGdsp_URL:
                    value = string.Copy(_url);
                    break;

                case (int)OPOSGraphicDisplayInternals.PIDXGdsp_VideoType:
                    value = string.Copy(_videoType);
                    break;

                case (int)OPOSGraphicDisplayInternals.PIDXGdsp_VideoTypeList:
                    value = string.Copy(_videoTypeList);
                    break;

                case (int)OPOSGraphicDisplayInternals.PIDXGdsp_CapAssociatedHardTotalsDevice:
        ...
        public int PlayVideo(string FileName, bool Loop)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
