...
namespace OpenPOS.CSSO
{
    ...
    [ComVisible(true)]
    [Guid("B90279D8-1416-47F0-99BD-1B137C09E1DD")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("OPOS.DeviceMonitor.OpenPOS.CSSO.CSDeviceMonitorSO.1")]
    public class CSDeviceMonitorSO : IOPOSDeviceMonitorSO, IDisposable
    {
        ...
        internal string _deviceData;
        internal string _deviceList;
        internal string _monitoringDeviceList;
        ...
        public CSDeviceMonitorSO()
        {
            ...
            _deviceData = string.Empty;
            _deviceList = string.Empty;
            _monitoringDeviceList = string.Empty;
        ...
        {
            if (registerType != typeof(CSDeviceMonitorSO))
            {
                return;
            }
        ...
        public string GetPropertyString(int PropIndex)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSDeviceMonitorInternals.PIDXDmon_DeviceData:
                    value = _deviceData;
                    break;

                case (int)OPOSDeviceMonitorInternals.PIDXDmon_DeviceList:
                    value = _deviceList;
                    break;

                case (int)OPOSDeviceMonitorInternals.PIDXDmon_MonitoringDeviceList:
                    value = _monitoringDeviceList;
                    break;
            }
        ...
        public int AddMonitoringDevice(string DeviceID, int MonitoringMode, int Boundary, int SubBoundary, int IntervalTime)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int ClearMonitoringDevice()
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int DeleteMonitoringDevice(string DeviceID)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int GetDeviceValue(string DeviceID, out int pValue)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            pValue = 0;
