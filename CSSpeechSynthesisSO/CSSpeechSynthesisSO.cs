...
namespace OpenPOS.CSSO
{
    ...
    [ComVisible(true)]
    [Guid("D4FC79B8-F700-407E-B4B7-4974A4CC6BE2")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("OPOS.SpeechSynthesis.OpenPOS.CSSO.CSSpeechSynthesisSO.1")]
    public class CSSpeechSynthesisSO : IOPOSSpeechSynthesisSO, IDisposable
    {
        ...
        internal bool _capSpeed;
        internal bool _capVoice;
        internal bool _capVolume;

        internal string _language;
        internal string _languageList;
        internal string _outputIDList;
        internal string _voice;
        internal string _voiceList;
        ...
        public CSSpeechSynthesisSO()
        {
            ...
            _outputIDList = string.Empty;
            _voice = string.Empty;
            _voiceList = string.Empty;
        ...
        {
            if (registerType != typeof(CSSpeechSynthesisSO))
            {
                return;
            }
        ...
        public int GetPropertyNumber(int PropIndex)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSSpeechSynthesisInternals.PIDXSpch_Pitch:
                    value = _pitch;
                    break;

                case (int)OPOSSpeechSynthesisInternals.PIDXSpch_Speed:
                    value = _speed;
                    break;

                case (int)OPOSSpeechSynthesisInternals.PIDXSpch_Volume:
                    value = _volume;
                    break;

                case (int)OPOSSpeechSynthesisInternals.PIDXSpch_CapLanguage:
                    value = Convert.ToInt32(_capLanguage);
                    break;

                case (int)OPOSSpeechSynthesisInternals.PIDXSpch_CapPitch:
                    value = Convert.ToInt32(_capPitch);
                    break;

                case (int)OPOSSpeechSynthesisInternals.PIDXSpch_CapSpeed:
                    value = Convert.ToInt32(_capSpeed);
                    break;

                case (int)OPOSSpeechSynthesisInternals.PIDXSpch_CapVoice:
                    value = Convert.ToInt32(_capVoice);
                    break;

                case (int)OPOSSpeechSynthesisInternals.PIDXSpch_CapVolume:
        ...
        public string GetPropertyString(int PropIndex)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSSpeechSynthesisInternals.PIDXSpch_Language:
                    value = string.Copy(_language);
                    break;

                case (int)OPOSSpeechSynthesisInternals.PIDXSpch_LanguageList:
                    value = string.Copy(_languageList);
                    break;

                case (int)OPOSSpeechSynthesisInternals.PIDXSpch_OutputIDList:
                    value = string.Copy(_outputIDList);
                    break;

                case (int)OPOSSpeechSynthesisInternals.PIDXSpch_Voice:
                    value = string.Copy(_voice);
                    break;

                case (int)OPOSSpeechSynthesisInternals.PIDXSpch_VoiceList:
                    value = string.Copy(_voiceList);
                    break;
            }
        ...
        public int SpeakImmediate(string Text)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int StopCurrentSpeaking()
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int StopSpeaking(int OutputID)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
