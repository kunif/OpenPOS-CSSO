...
namespace OpenPOS.CSSO
{
    ...
    [ComVisible(true)]
    [Guid("3788DE86-DB55-48FC-9D08-00DE42608D98")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("OPOS.PINPad.OpenPOS.CSSO.CSPINPadSO.1")]
    public class CSPINPadSO : IOPOSPINPadSO, IDisposable
    {
        ...
        internal int _maximumPINLength;
        internal int _minimumPINLength;
        internal bool _pINEntryEnabled;
        internal int _prompt;
        internal int _promptLanguage;
        internal int _transactionType;

        internal int _capDisplay;
        internal bool _capKeyboard;
        internal int _capLanguage;
        internal bool _capMACCalculation;
        internal bool _capTone;

        internal string _accountNumber;
        internal string _additionalSecurityInformation;
        internal string _availableLanguagesList;
        internal string _availablePromptsList;
        internal string _encryptedPIN;
        internal string _merchantID;
        internal string _terminalID;
        ...
        public CSPINPadSO()
        {
            ...
            _capKeyboard = false;
            _capLanguage = 0;
            _capMACCalculation = false;
            _capTone = false;

            _accountNumber = string.Empty;
            _additionalSecurityInformation = string.Empty;
            _availableLanguagesList = string.Empty;
            _availablePromptsList = string.Empty;
            _encryptedPIN = string.Empty;
        ...
        {
            if (registerType != typeof(CSPINPadSO))
            {
                return;
            }
        ...
        public int GetPropertyNumber(int PropIndex)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSPINPadInternals.PIDXPpad_MaximumPINLength:
                    value = _maximumPINLength;
                    break;

                case (int)OPOSPINPadInternals.PIDXPpad_MinimumPINLength:
                    value = _minimumPINLength;
                    break;

                case (int)OPOSPINPadInternals.PIDXPpad_PINEntryEnabled:
                    value = Convert.ToInt32(_pINEntryEnabled);
                    break;

                case (int)OPOSPINPadInternals.PIDXPpad_Prompt:
                    value = _prompt;
                    break;

                case (int)OPOSPINPadInternals.PIDXPpad_PromptLanguage:
                    value = _promptLanguage;
                    break;

                case (int)OPOSPINPadInternals.PIDXPpad_TransactionType:
                    value = _transactionType;
                    break;

                case (int)OPOSPINPadInternals.PIDXPpad_CapDisplay:
                    value = _capDisplay;
                    break;

                case (int)OPOSPINPadInternals.PIDXPpad_CapKeyboard:
                    value = Convert.ToInt32(_capKeyboard);
                    break;

                case (int)OPOSPINPadInternals.PIDXPpad_CapLanguage:
                    value = _capLanguage;
                    break;

                case (int)OPOSPINPadInternals.PIDXPpad_CapMACCalculation:
                    value = Convert.ToInt32(_capMACCalculation);
                    break;

                case (int)OPOSPINPadInternals.PIDXPpad_CapTone:
        ...
        public void SetPropertyNumber(int PropIndex, int Number)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSPINPadInternals.PIDXPpad_MaximumPINLength:
                    _maximumPINLength = Number;
                    break;

                case (int)OPOSPINPadInternals.PIDXPpad_MinimumPINLength:
                    _minimumPINLength = Number;
                    break;
        ...
        public string GetPropertyString(int PropIndex)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSPINPadInternals.PIDXPpad_AccountNumber:
                    value = _accountNumber;
                    break;

                case (int)OPOSPINPadInternals.PIDXPpad_AdditionalSecurityInformation:
                    value = _additionalSecurityInformation;
                    break;

                case (int)OPOSPINPadInternals.PIDXPpad_AvailableLanguagesList:
                    value = _availableLanguagesList;
                    break;

                case (int)OPOSPINPadInternals.PIDXPpad_AvailablePromptsList:
                    value = _availablePromptsList;
                    break;

                case (int)OPOSPINPadInternals.PIDXPpad_EncryptedPIN:
                    value = _encryptedPIN;
                    break;

                case (int)OPOSPINPadInternals.PIDXPpad_MerchantID:
                    value = _merchantID;
                    break;

                case (int)OPOSPINPadInternals.PIDXPpad_TerminalID:
                    value = _terminalID;
                    break;

                case (int)OPOSPINPadInternals.PIDXPpad_Track1Data:
                    value = SOCommon.ToStringFromByteArray(_track1Data, _binaryConversion);
                    break;

                case (int)OPOSPINPadInternals.PIDXPpad_Track2Data:
                    value = SOCommon.ToStringFromByteArray(_track2Data, _binaryConversion);
                    break;

                case (int)OPOSPINPadInternals.PIDXPpad_Track3Data:
                    value = SOCommon.ToStringFromByteArray(_track3Data, _binaryConversion);
                    break;

                case (int)OPOSPINPadInternals.PIDXPpad_Track4Data:
        ...
        public void SetPropertyString(int PropIndex, string String)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSPINPadInternals.PIDXPpad_Track1Data:
                    _track1Data = SOCommon.ToByteArrayFromString(String, _binaryConversion);
                    break;

                case (int)OPOSPINPadInternals.PIDXPpad_Track2Data:
                    _track2Data = SOCommon.ToByteArrayFromString(String, _binaryConversion);
                    break;

                case (int)OPOSPINPadInternals.PIDXPpad_Track3Data:
                    _track3Data = SOCommon.ToByteArrayFromString(String, _binaryConversion);
                    break;

                case (int)OPOSPINPadInternals.PIDXPpad_Track4Data:
                    _track4Data = SOCommon.ToByteArrayFromString(String, _binaryConversion);
                    break;
            }
        ...
        #region OPOS ServiceObject Device Specific Property
        ...
        #endregion OPOS ServiceObject Device Specific Property

        #region OPOS ServiceObject Device Specific Method

        public int BeginEFTTransaction(string PINPadSystem, int TransactionHost)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int ComputeMAC(string InMsg, out string pOutMsg)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            pOutMsg = string.Empty;
            return _resultCode;
        }

        public int EnablePINEntry()
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int EndEFTTransaction(int CompletionCode)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int UpdateKey(int KeyNum, string Key)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int VerifyMAC(string Message)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
