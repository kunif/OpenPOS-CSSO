...
namespace OpenPOS.CSSO
{
    ...
    [ComVisible(true)]
    [Guid("4D1AB0B0-9AB8-4DF0-AA62-94239E4B51C6")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("OPOS.BumpBar.OpenPOS.CSSO.CSBumpBarSO.1")]
    public class CSBumpBarSO : IOPOSBumpBarSO, IDisposable
    {
        ...
        internal int _bumpBarDataCount;
        ...
        {
            if (registerType != typeof(CSBumpBarSO))
            {
                return;
            }
        ...
        public int GetPropertyNumber(int PropIndex)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSBumpBarInternals.PIDXBb_AsyncMode:
                    value = Convert.ToInt32(_asyncMode);
                    break;

                case (int)OPOSBumpBarInternals.PIDXBb_AutoToneDuration:
                    value = _autoToneDuration;
                    break;

                case (int)OPOSBumpBarInternals.PIDXBb_AutoToneFrequency:
                    value = _autoToneFrequency;
                    break;

                case (int)OPOSBumpBarInternals.PIDXBb_BumpBarDataCount:
                    value = _bumpBarDataCount;
                    break;

                case (int)OPOSBumpBarInternals.PIDXBb_CurrentUnitID:
                    value = _currentUnitID;
                    break;

                case (int)OPOSBumpBarInternals.PIDXBb_ErrorUnits:
                    value = _errorUnits;
                    break;

                case (int)OPOSBumpBarInternals.PIDXBb_EventUnitID:
                    value = _eventUnitID;
                    break;

                case (int)OPOSBumpBarInternals.PIDXBb_EventUnits:
                    value = _eventUnits;
                    break;

                case (int)OPOSBumpBarInternals.PIDXBb_Keys:
                    value = _keys;
                    break;

                case (int)OPOSBumpBarInternals.PIDXBb_Timeout:
                    value = _timeout;
                    break;

                case (int)OPOSBumpBarInternals.PIDXBb_UnitsOnline:
                    value = _unitsOnline;
                    break;

                case (int)OPOSBumpBarInternals.PIDXBb_CapTone:
        ...
        public string GetPropertyString(int PropIndex)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSBumpBarInternals.PIDXBb_ErrorString:
                    value = string.Copy(_errorString);
                    break;

                case (int)OPOSBumpBarInternals.PIDXBb_EventString:
                    value = string.Copy(_eventString);
                    break;
            }
        ...
        public int BumpBarSound(int Units, int Frequency, int Duration, int NumberOfCycles, int InterSoundWait)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int SetKeyTranslation(int Units, int ScanCode, int LogicalKey)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
