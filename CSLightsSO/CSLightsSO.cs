...
namespace OpenPOS.CSSO
{
    ...
    [ComVisible(true)]
    [Guid("A465DD56-9718-4272-AD95-7E2E62B5A9CC")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("OPOS.Lights.OpenPOS.CSSO.CSLightsSO.1")]
    public class CSLightsSO : IOPOSLightsSO_1_16, IDisposable
    {
        ...
        internal int _maxLights;

        internal int _capAlarm;
        internal bool _capBlink;
        internal int _capColor;
        internal int _capPattern;
        ...
        {
            if (registerType != typeof(CSLightsSO))
            {
                return;
            }
        ...
        public int GetPropertyNumber(int PropIndex)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSLightsInternals.PIDXLgt_MaxLights:
                    value = _maxLights;
                    break;

                case (int)OPOSLightsInternals.PIDXLgt_CapAlarm:
                    value = _capAlarm;
                    break;

                case (int)OPOSLightsInternals.PIDXLgt_CapBlink:
                    value = Convert.ToInt32(_capBlink);
                    break;

                case (int)OPOSLightsInternals.PIDXLgt_CapColor:
                    value = _capColor;
                    break;

                case (int)OPOSLightsInternals.PIDXLgt_CapPattern:
                    value = _capPattern;
                    break;
            }
        ...
        public int SwitchOn(int LightNumber, int BlinkOnCycle, int BlinkOffCycle, int Color, int Alarm)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int SwitchOff(int LightNumber)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int SwitchOnPattern(int Pattern, int Alarm)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
        ...
        public int SwitchOnMultiple(string LightNumbers, int BlinkOnCycle, int BlinkOffCycle, int Color, int Alarm)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
