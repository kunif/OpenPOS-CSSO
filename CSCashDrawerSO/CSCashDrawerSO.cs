...
namespace OpenPOS.CSSO
{
    ...
    [ComVisible(true)]
    [Guid("34B12A8F-DC83-42D4-9CC2-965B89113DDF")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("OPOS.CashDrawer.OpenPOS.CSSO.CSCashDrawerSO.1")]
    public class CSCashDrawerSO : IOPOSCashDrawerSO, IDisposable
    {
        ...
        internal bool _drawerOpened;

        internal bool _capStatus;
        internal bool _capStatusMultiDrawerDetect;
        ...
        public CSCashDrawerSO()
        {
            ...
            _capStatus = false;
            _capStatusMultiDrawerDetect = false;
        ...
        {
            if (registerType != typeof(CSCashDrawerSO))
            {
                return;
            }
        ...
        public int GetPropertyNumber(int PropIndex)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSCashDrawerInternals.PIDXCash_DrawerOpened:
                    value = Convert.ToInt32(_drawerOpened);
                    break;

                case (int)OPOSCashDrawerInternals.PIDXCash_CapStatus:
                    value = Convert.ToInt32(_capStatus);
                    break;

                case (int)OPOSCashDrawerInternals.PIDXCash_CapStatusMultiDrawerDetect:
                    value = Convert.ToInt32(_capStatusMultiDrawerDetect);
                    break;
            }
