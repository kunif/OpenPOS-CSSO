...
namespace OpenPOS.CSSO
{
    ...
    [ComVisible(true)]
    [Guid("FD1F1124-4651-4D6E-BAE4-63D62C4C79E3")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("OPOS.MotionSensor.OpenPOS.CSSO.CSMotionSensorSO.1")]
    public class CSMotionSensorSO : IOPOSMotionSensorSO, IDisposable
    {
        ...
        {
            if (registerType != typeof(CSMotionSensorSO))
            {
                return;
            }
        ...
        public int GetPropertyNumber(int PropIndex)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSMotionSensorInternals.PIDXMotion_Timeout:
                    value = _timeout;
                    break;

                case (int)OPOSMotionSensorInternals.PIDXMotion_Motion:
                    value = Convert.ToInt32(_motion);
                    break;
            }
        ...
        public int WaitForMotion(int Timeout)
        {
            _resultCode = (int)OPOS_Constants.OPOS_E_ILLEGAL;
            _resultCodeExtended = 0;
            return _resultCode;
