...
namespace OpenPOS.CSSO
{
    ...
    [ComVisible(true)]
    [Guid("D7699FF4-73BE-4E96-8518-38F175896AFA")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("OPOS.POSKeyboard.OpenPOS.CSSO.CSPOSKeyboardSO.1")]
    public class CSPOSKeyboardSO : IOPOSPOSKeyboardSO, IDisposable
    {
        ...
        internal int _posKeyData;
        internal int _eventTypes;
        internal int _posKeyEventType;

        internal bool _capKeyUp;
        ...
        {
            if (registerType != typeof(CSPOSKeyboardSO))
            {
                return;
            }
        ...
        public int GetPropertyNumber(int PropIndex)
        {
            ...
            switch (PropIndex)
            {
                ...
                case (int)OPOSPOSKeyboardInternals.PIDXKbd_POSKeyData:
                    value = _posKeyData;
                    break;

                case (int)OPOSPOSKeyboardInternals.PIDXKbd_EventTypes:
                    value = _eventTypes;
                    break;

                case (int)OPOSPOSKeyboardInternals.PIDXKbd_POSKeyEventType:
                    value = _posKeyEventType;
                    break;

                case (int)OPOSPOSKeyboardInternals.PIDXKbd_CapKeyUp:
                    value = Convert.ToInt32(_capKeyUp);
                    break;
            }
